...
For more information, please read the alfred-gpsd section of the "README":http://git.open-mesh.org/alfred.git/blob_plain/refs/heads/master:/README or the "manpage":http://downloads.open-mesh.org/batman/manpages/batadv-vis.html for usage.
