...
For more information, please read the alfred-gpsd section of the "README":https://git.open-mesh.org/alfred.git/tree/README.rst or the "manpage":https://downloads.open-mesh.org/batman/manpages/alfred-gpsd.html for usage.