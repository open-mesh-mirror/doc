...
If you intend to create images like the one below you need to use one of the many tools available. That screenshot was made by connecting mesh3d (which is part of the "s3d tools":http://s3d.sourceforge.net/ - debian packages are available) to the vis servers dot draw output (on port 2004).
