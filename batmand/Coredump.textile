...
== Why do I need ulimit and what does it do ? ==
  ...
  easily. Therefore the tool "ulimit" allows you to control what memory size is too [[BR]]
  big to be saved on disk. A "ulimit -c 20000" saves coredumps of up to 20MB, [[BR]]
  "ulimit -c unlimited" saves everything no matter how big it is. You can check [[BR]]
  your systems default by running "ulimit" without any options. If the value is [[BR]]
