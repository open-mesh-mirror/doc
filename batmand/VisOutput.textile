...
output with a map  or want to understand the vis server output for another reason. [[BR]]
''If you want to setup the vis server for the batmand have a look at this [wiki:VisualizeMesh article] or for [[BR]]
BATMAN-Advanced at [wiki:VisAdv this one]. [[BR]]
...
=== Interfaces belonging to one BATMAN-Node ===
