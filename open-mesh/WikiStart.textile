 ...
 * in the long term we are envisioning an advanced batman which also enables layer-two routing. This will be available via: [[br]] svn co https://dev.open-mesh.org/svn/batman/trunk/batman-advanced
