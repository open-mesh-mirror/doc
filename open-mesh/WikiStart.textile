 ...
 * to build batman advanced which also enables layer-two routing you need to checkout the complete trunk: [[br]] svn co https://dev.open-mesh.org/svn/batman/trunk/ [[br]] Then go into the batman-advanced folder and compile the sources
