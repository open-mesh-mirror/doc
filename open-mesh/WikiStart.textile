...
This is the home of the B.A.T.M.A.N. development. To get some more general information about this project have a look at [https://open-mesh.org/batman/ https://open-mesh.org/batman/] .
...
We are currently working on three different branch. Namely

 * our stable batman branch (the one currently operating in Berlin and Leipzig). It can be checked out with: "svn co https://dev.open-mesh.org/svn/batman/batman"

 * then, we have an experimental branch which implements some new/other algorithms and features referred to as batman-experimental and accessible via: "svn co https://dev.open-mesh.org/svn/batman/batman-experimental"

 * in the long term we are envisioning a next-generation-batman which also enables layer-two routing and which will be available via: "svn co https://dev.open-mesh.org/svn/batman/batman-ng"


Have a lot of fun and remember:[[BR]]
We are desperately waiting fo your feedback![[BR]]
