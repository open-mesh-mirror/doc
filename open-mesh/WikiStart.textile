 ...
 * our stable batman branch (the one currently operating in Berlin, and others). It can be checked out with: [[br]] svn co https://dev.open-mesh.org/svn/batman/branches/batman-0.2.x/

 * our development batman branch. It can be checked out with: [[br]] svn co https://dev.open-mesh.org/svn/batman/trunk/batman/
 ...
 * to build batman advanced which also enables layer-two routing you need to checkout the complete trunk: [[br]] svn co https://dev.open-mesh.org/svn/batman/trunk/batman-advanced [[br]] Then change to the batman-advanced folder and compile the sources
