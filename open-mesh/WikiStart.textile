...
[[br]]
svn co http://downloads.open-mesh.org/svn/batman/


We are currently working on different branches. To get the details about the differences of these branches, please visit: [https://www.open-mesh.org/batman/doc/BranchesExplained https://www.open-mesh.org/batman/doc/BranchesExplained]

 * our stable batman branch (the one currently operating in Berlin, and others) can be checked out with: [[br]] svn co https://dev.open-mesh.org/svn/batman/branches/batman-0.2.x/

 * our development batman branch can be checked out with: [[br]] svn co https://dev.open-mesh.org/svn/batman/trunk/batman/

 * the experimental branch is accessible via: [[br]] svn co https://dev.open-mesh.org/svn/batman/trunk/batman-experimental

 * to build batman advanced you need to checkout the complete trunk: [[br]] svn co https://dev.open-mesh.org/svn/batman/trunk/ [[br]] Then change to the batman-advanced folder and compile the sources
