...
This is the home of the B.A.T.M.A.N. development. To get some more general information about this project have a look at [https://open-mesh.org/batman/ https://open-mesh.net/batman/] .
 ...
 * in the long term we are envisioning an advanced batman which also enables layer-two routing. This which will be available via: [[br]] svn co https://dev.open-mesh.org/svn/batman/trunk/batman-advanced
