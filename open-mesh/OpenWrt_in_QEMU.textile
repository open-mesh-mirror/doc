...
#BOOTARGS+=("-append" "root=/dev/vda rw console=ttyS0 nokaslr tsc=reliable no_timer_check noreplace-smp rootfstype=ext4 rcupdate.rcu_expedited=1 reboot=t pci=lastbus=0")
