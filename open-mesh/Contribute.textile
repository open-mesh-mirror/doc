 ...
 * Patches must be against trunk and have an additional prefix before the actual project subdirectory. It must be possible to apply those patches on top of a checkout of the svn trunk directory using {{{patch -p1 -i $PATCH}}}
