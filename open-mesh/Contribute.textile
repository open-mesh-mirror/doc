 ...
 * Patches sent to the mailing list should include "PATCH" in the subject to make[[BR]]
   it easier to distinguish between patches and discussion.
 ...
 * Patches for B.A.T.M.A.N. Advanced need to follow the linux kernel coding style[[BR]]
   closely (check it using checkpatch.pl) as well as the linux "how to submit pacthes"[[BR]]
   guidelines (search for the term !SubmitPatches to find thourough documentation).
