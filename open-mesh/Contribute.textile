...
Thanks for using B.A.T.M.A.N.! If you have suggestions, comments, want to tell us about your experiences or discuss problems the best thing is always to use the [[MailingList|Mailing List] You can always contact us via [wikiIRC IRC]].
...
If you find a bug, please see if the problem is already known in the by "Reading the Tickets":https://dev.open-mesh.org/batman/report. 

If not, please "add a new Ticket":https://dev.open-mesh.org/batman/newticket.
...
* [[Coredump|get a coredump]] if you experience a segfault
* your guess what triggered the problem. ;)


h3. Documentation / Feedback
...
<pre>
* Patches against the batman-adv master branch must be formated using
<pre>
git format-patch -M --patience --src-prefix=a/batman-adv/ --dst-prefix=b/batman-adv/ $BASECOMMIT
</code></pre>
