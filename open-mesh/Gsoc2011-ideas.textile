...
h3. Categories + Usecases to improve
...
h4. OGM/NDP Hidden Node Problem Avoidance
...
A suitable solution shall be implemented. This might be based on time slots, multiple interfaces or channel switching and might be implemented within batman-adv or an extra module. See [[batman-adv:bcast-hidden-node|here]] for a more detailed description of the problem and a solution proposal.


h4. OGM/NDP Congestion Avoidance
...
h4. B.A.T.M.A.N. Routing Framework
...
h4. IPv6 Stateless Autoconf Gateway Solution
...
h4. Dead node fast path switching/invalidating
...
* "Network Coding":http://en.wikipedia.org/wiki/Network_coding?
