...
A suitable solution shall be implemented. This might be based on time slots, multiple interfaces or channel switching and might be implemented within batman-adv or an extra module. See [[bcast-hidden-node|here]] for a more detailed description of the problem and a solution proposal.
