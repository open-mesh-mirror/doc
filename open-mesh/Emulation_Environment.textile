...
* interconnect to allow commmunication between the virtual instances
...
h2. Advanced interconnects

The default interconnect is only creating a single broadcasting domain using a bridge. This cannot be used to simulate interesting topologies. I more advanced techniques can be used to extend or replace the bridge to still achieve a reasonable setup

* [[bridge interconnect]]
* [[vde_switch interconnect]]
* [[mixing VM with gluon hardware]]

h2. Debugging helpers

* [[Analyzing interconnect packets]]
