...
<pre>
git clone https://git.open-mesh.org/linux-merge.git
</pre>
...
The master branch will have all upcoming changes. Bugfixes are merged from next to master.

h3. next branch

The next gathers bug fixes for the latest release and well tested features taken from the master branch. Merges are usually used to get  changes from master to next and to get bugfixes from maint to next.
...
git pull https://git.open-mesh.org/batman-adv.git next
</pre>
