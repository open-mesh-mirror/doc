h1. T H E   J O K E R - B.A.T.M.A.N.'s arch nemesis
 ...
 * git web directory: http://git.open-mesh.org/joker.git
 * git download: git clone git://git.open-mesh.org/joker.git
 * snapshot:http://git.open-mesh.org/joker.git/snapshot/refs/heads/master.tar.gz

h2. Usage

<pre>
 ./joker -i <interface> [other options]
</pre>
...
The critical resource is every node’s route memory and CPU power needed for route lookups.
