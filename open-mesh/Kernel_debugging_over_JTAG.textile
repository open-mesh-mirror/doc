...
"debugged using JTAG":https://openwrt.org/docs/techref/hardware/port.jtag
...
The connection between the debug adapter and the target board must established by connecting a couple of pins with each other.
...
The Bus Blaster v3 with the 20 pin header and the default buffer logic the usage of the pins already written next to header.
