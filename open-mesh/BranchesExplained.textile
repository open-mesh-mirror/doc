...
Initially, this branch was used to experiment with new approaches to overcome certain limitations of the routing algorithm. It started on the code base of batmand 0.3 but, over time, developed into a completely different direction, so that a re-integration became impossible. Nowadays, it is considered an independent project. [[BR]]

Some documentation can be found [wiki:BMX here].
