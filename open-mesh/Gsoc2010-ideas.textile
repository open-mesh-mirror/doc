...
These things are not a prerequisite but might be very useful and/or have to be learned turing the GSoC anyway.
 * [[http://www.kernel.org/doc/Documentation/CodingStyle Linux kernel coding style]]
 * Reading the documentation of the algorithms: [[http://gitorious.org/batman-adv-doc batman-adv-doc]] [[http://tools.ietf.org/html/draft-wunderlich-openmesh-manet-routing-00 batman-rfc-draft]] (used in the 'old' batmand)
 ...
 * monitoring packet flow (using tcpdump / wireshark + [[http://gitorious.org/wireshark-batman-plugins/wireshark-batman-adv wireshark-batman-adv dissector]]
