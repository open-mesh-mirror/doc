 ...
 * BMX-0.3.x branch: [[BR]]''{{{svn co http://downloads.open-mesh.org/svn/batman/branches/bmx-0.3.x/}}}'' and http://git.bmx6.net/?p=bmxd.git;a=summary
 * upcoming BMX6-0.1 branch (unstable): [[BR]]''{{{svn co http://downloads.open-mesh.org/svn/batman/trunk/bmx/}}}'' also check new website at http://www.bmx6.net
