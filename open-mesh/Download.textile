 ...
 * The latest version of [wiki:batman-adv batman-adv] is [http://downloads.open-mesh.org/batman/stable/sources/batman-adv/batman-adv-2010.1.0.tar.gz batman-adv-2010.1.0.tar.gz] [http://downloads.open-mesh.org/batman/stable/sources/batman-adv/batman-adv-2010.1.0.tar.gz.md5 md5] [http://downloads.open-mesh.org/batman/stable/sources/batman-adv/batman-adv-2010.1.0.tar.gz.sha1 sha1] [http://downloads.open-mesh.org/batman/stable/sources/batman-adv/batman-adv-2010.1.0.tar.gz.asc asc]
 * The latest version of batctl (management and control tool for batman-adv) is [http://downloads.open-mesh.org/batman/stable/sources/batctl/batctl-2010.1.0.tar.gz batctl-2010.1.0.tar.gz] [http://downloads.open-mesh.net/batman/stable/sources/batctl/batctl-2010.1.0.tar.gz.md5 md5] [http://downloads.open-mesh.org/batman/stable/sources/batctl/batctl-2010.1.0.tar.gz.sha1 sha1] [http://downloads.open-mesh.org/batman/stable/sources/batctl/batctl-2010.1.0.tar.gz.asc asc]
 ...
 * upcoming B.A.T.M.A.N. 0.4.0 branch '''(maintainer needed!)''': [[BR]]''{{{svn co http://downloads.open-mesh.net/svn/batman/trunk/batman/}}}''
 ...
 * [http://packages.debian.org/sid/batman-adv-source batman-adv-source] - batman-advanced kernel 2010.0.0 module source (installable via [http://packages.debian.org/sid/module-assistant module-assistant])
 * [http://packages.debian.org/sid/batman-adv-dkms batman-adv-dkms] - batman-advanced kernel module 2010.0.0 dkms package to build new modules dynamically (half-automatic)
 * [http://packages.debian.org/sid/batctl batctl] - batctl 2010.0.0
