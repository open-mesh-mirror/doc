...
* The latest version of [[batman-adv:Wiki|batman-adv]] is "batman-adv-2011.3.0.tar.gz":http://downloads.open-mesh.org/batman/stable/sources/batman-adv/batman-adv-2011.3.0.tar.gz "md5":http://downloads.open-mesh.org/batman/stable/sources/batman-adv/batman-adv-2011.3.0.tar.gz.md5 "sha1":http://downloads.open-mesh.org/batman/stable/sources/batman-adv/batman-adv-2011.3.0.tar.gz.sha1 "asc":http://downloads.open-mesh.org/batman/stable/sources/batman-adv/batman-adv-2011.3.0.tar.gz.asc
...
* linux 2.6.39 => batman-adv 2011.1.0 (get batctl 2011.1.0 from "here":http://downloads.open-mesh.org/batman/stable/sources/batctl/)
* linux 3.0 => batman-adv 2011.2.0 (get batctl 2011.2.0 from "here":http://downloads.open-mesh.org/batman/stable/sources/batctl/)
* linux 3.1 => batman-adv 2011.3.0 (get batctl 2011.3.0 from "here":http://downloads.open-mesh.org/batman/stable/sources/batctl/)
