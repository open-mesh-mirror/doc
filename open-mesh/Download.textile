...
> <pre>
svn co http://downloads.open-mesh.org/svn/batman/trunk/batman-adv/
</pre>
* batctl (for B.A.T.M.A.N. advanced): check out the complete repository, cd into batctl (we're using symlinks here ...): 
> <pre>
svn co http://downloads.open-mesh.org/svn/batman/trunk/
</pre>
* complete repository: 
> <pre>
svn co http://downloads.open-mesh.org/svn/batman/trunk/
...
> <pre>
svn co http://downloads.open-mesh.org/svn/batman/trunk/batman/
</pre>
