...
* "batman-adv":https://git.open-mesh.org/batman-adv.git/log/?h=linus/multicast-mld-rtr-only
* "batctl":https://git.open-mesh.org/batctl.git/log/?h=linus/multicast-rtr-only
...
_tl;dr:_ Scenario C is the potentially unsafe scenario for a _multicast_mld_rtr_only_ option.
...
h3. Scenario D: Multicast from host on node with a bridged-in querier

h4. Scenario D, Overview:

!mld-to-mcast-routers-only-scenario-D-overview.png!
_Can bridged-in host B send multicast to bridged-in host A?_

h4. Scenario D, Analysis:

Answer: yes

!mld-to-mcast-routers-only-scenario-D.png!
...
h4. Scenario E, Overview:

!mld-to-mcast-routers-only-scenario-E-overview.png!
_Can bridged-in host B send multicast to bridged-in host A?_

h4. Scenario E, Analysis:

Answer: yes

!mld-to-mcast-routers-only-scenario-E.png!
