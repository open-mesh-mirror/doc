...
To catch _all_, local rebroadcast avoidance possibilities, B would simply perform such ingress and egress checks for any neighbor Cn (any neighbor other than A):
