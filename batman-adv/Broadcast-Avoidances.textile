...
For smaller neighborhoods an approach with a higher, computational overhead might be feasible: The neighborhood hash rules are very broad, not able to detect many common wireless topologies where rebroadcasts could be avoided.
