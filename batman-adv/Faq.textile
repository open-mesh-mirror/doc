...
*A:* IPv6 will help you to do this easier by using "Unique local address":http://en.wikipedia.org/wiki/Unique_local_address (ULA).
...
*A:* Bridge Loop Avoidance is used to detect and avoid loops due to multiple batX interfaces. "Read more...":http://www.open-mesh.org/projects/batman-adv/wiki/Bridge-loop-avoidance
