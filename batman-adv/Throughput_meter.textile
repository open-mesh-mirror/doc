...
In order to provide an easier protocol to implement, Go-Back-N is used, with a static window. For protocol beginning and termination an TFTP like approach is used. To terminate the protocol, a packet of not-full lenght is sent.

h2. TODO

h3. Currently doing

* try virtual machines for testbed: I am configuring a virtual machine with Debian and kernel 3.2.12 to test the modifications introduced in order to call the bandwidth meter through batctl;
