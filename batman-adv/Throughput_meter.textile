...
## If sender, after all data is sent, send FIN. A packet with FIN flag should be received back from the other node, meaning that all data has been delivered, thus the test is over.
