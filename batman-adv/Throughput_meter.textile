...
This project was started by Edo Monticelli during his 2012 Google Summer Of Code and it is possible to read his final report [[open-mesh:2012-10-06-GSoC-2012-Edo-Monticellis-Final-Report|here]].
...
More technical details are discussed on the [[bandwidth_meter_debug|technical and debug page]].
...
h3. Starting a new session on the receiver
...
* Performance registered by the bandwidth meter and by iperf on a simple topology made up by two nodes connected wirelessly is mostly the same. Theoretically we expected a not negligible difference due to the context switch, but this has not been verified. More tests in different setups will be reported.
