...
* uid, introduce a receiver timeout to free structures if sender goes away
* new branch with go-back-n
* bitmap on receiver side
* wrap-around
...
* -integrate into batctl- *function* batadv_socket_receive_packet(), used to send packets to userspace through the socket, accepts batadv_icmp_packet_rr only. At the moment using cast to mask. Is it ok or is there a more suitable solution ? *interesting  http://bpaste.net/show/38333/*,   http://bpaste.net/show/38334/
