...
* struct list_head bw_list; a list of struct bw_vars, part of bat_priv;
* structures bw_vars, bw_list elements and "connection" specific: one bw_vars exists for each source or destination;
...
The protection of struc bw_vars is a bit more complex, and it differs in the sender and in the receiver.
...
ACK's handler execute atomically, using a spinlock declared in bw_vars as bw_ack_lock.
