...
The bandwidth meter protocol is the implementation of TCP with a congestion handling mechanism like NewReno.

Details can be found in:
* "RFC 5681":http://tools.ietf.org/html/rfc5681
* "RFC 6582":http://tools.ietf.org/html/rfc6582
...
Since the test is performed unidirectionally, ACKs are not piggybacked on normal messages (like TCP does) and therefore two different packet types were required.
