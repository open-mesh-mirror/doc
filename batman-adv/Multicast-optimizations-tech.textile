...
| *routable* |=. supported without bridges³.
...
³: Routable IPv4 multicast addresses in bridged scenarios are not supported yet. See  [[multicast-optimizations-tech#routable-multicast-addresses]] for details.
