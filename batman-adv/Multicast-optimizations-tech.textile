...
|                                    | *IPv4*          | *IPv6* |
| *all nodes link-scope* |=. supported without bridges¹. Example: 224.0.0.1 (all nodes) |=. supported without bridges¹. Example: ff02::1 (all nodes) |
| *link-local*
(excl. all nodes addr.) |=. supported without bridges¹ |=. supported. Example: ff12::39 |
| *routable* |=. support planned² |=. support planned². Example: ff0e::101 (NTP) |
