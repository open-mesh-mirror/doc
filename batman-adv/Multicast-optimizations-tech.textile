...
Example: 224.0.0.251 (mDNS) |=. supported without bridges ².
...
²: To support scenarios with bridges, the according nodes need integration between batman-adv and the snooping part of their Linux bridge. Support for this is planned.
...
* [[multicast-optimizations-flags|Basic Multicast Optimizations – Flags Explained]]