...
It is necessary to activate the bridge loop avoidance at compile time before you can use this feature (consult "the README.external file":https://www.open-mesh.org/projects/batman-adv/repository/revisions/master/entry/README.external to learn how to set the compile option). 
...
It is necessary to activate the distributed ARP table at compile time before you can use this feature (consult "the README.external file":https://www.open-mesh.org/projects/batman-adv/repository/revisions/master/entry/README.external to learn how to set the compile option). 
...
It is necessary to activate network coding at compile time before you can use this feature (consult "the README.external file":https://www.open-mesh.org/projects/batman-adv/repository/revisions/master/entry/README.external to learn how to set the compile option). 
