...
The vis_mode and vis_data files provide a system to visualize the batman-adv network. The [[VisAdv|visualizing the 2nd layer] and [[VisOutput|vis output]] documents describes this system in detail, therefore no in-depth explanation is given here. 
