...
''Note'': If you want to build a current version of batman-adv, make sure you have ''"svn-src packages !svn://svn.openwrt.org/openwrt/packages"'' in your feeds.conf(.default)
