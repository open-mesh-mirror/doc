...
+Note+: If you downloaded an OpenWRT release but intend to build the latest batman-adv package you might need to modify your feeds.conf(.default). Make sure you have "src-svn packages svn://svn.openwrt.org/openwrt/packages" instead of e.g. "src-svn packages svn://svn.openwrt.org/openwrt/branches/packages_8.09".
