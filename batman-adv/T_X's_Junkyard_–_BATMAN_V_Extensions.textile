...
h3. Potential Router List / Store & Delayed Forward Mechanism ("OGM on hold")
...
h3. Forwarding OGMs via unicast
...
h3. Weaker Feasibility Conditions

TODO: Do weaker feasibility conditions actually enhance anything right now? Or would it only help if we wanted to react to link changes without needing a new seqno/RIP(-alikes)?
