...
* [[devtools:Emulation_Environment|Emulation HowTo]] - how to create an environment to emulate wireless setups using QEMU
* [[devtools:Kernel_Debugging|Kernel Debugging]] - various information how to debug kernel modules on real hardware or under QEMU
