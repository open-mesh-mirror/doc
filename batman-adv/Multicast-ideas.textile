...
More Info:
 *  "Batman-adv multicast optimization (video)":http://downloads.open-mesh.org/batman/misc/wbmv4-multicast.avi - how batman-adv optimizes multicast traffic by Linus and Simon [March 2011], slides are attached at the end of this document
...
* An IPv4 multicast packet from the "Local Network and Internet Work Control Blocks" (224.0.0.0/24, 224.0.1.0/24 - "RFC3171":http://tools.ietf.org/html/rfc3171). These are for instance IGMP- or mDNS-packets.
...
For a nice table of multicast IP- and MAC-address ranges, also see "this":http://en.wikipedia.org/wiki/Multicast_address nice wikipedia-article 
...
* ODMRP "draft-ietf-manet-odmrp-04":http://tools.ietf.org/html/draft-ietf-manet-odmrp-04,"wcnc99.pdf":http://www.hpl.hp.com/personal/Sung-Ju_Lee/abstracts/papers/wcnc99.pdf, 
* SMF "draft-ietf-manet-smf-10":http://tools.ietf.org/html/draft-ietf-manet-smf-10
* PGM "rfc3208":http://tools.ietf.org/html/rfc3208
