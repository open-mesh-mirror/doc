...
The current code is available in out "git repository":http://git.open-mesh.org/?p=batman-adv.git;a=shortlog;h=refs/heads/hundeboll/catwoman (the "catwoman" branch) and supports the following features:
