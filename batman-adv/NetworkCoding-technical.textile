...
* first_dest: Address of the first receiver of the network coded packet. This is commented out, as it is placed in the mac header.
...
* Construct a better algorithm to select which receiver to put in the MAC header destination field.
