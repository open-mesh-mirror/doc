...
First, try to minimise the complexity of your setup, i.e. just try to build a simple mesh network between two devices. Usually just following the [[quick-start-guide|quick-start-guide]] is a good way to start with.
...
h2. Do all nodes run the same batman-adv version ?
