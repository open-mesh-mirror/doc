...
Every batman node announces at least one mac address - the mac of the batX interface. 
...
* fe:fe:00:00:01:01 via fe:fe:00:00:02:01
</pre>
...
The gateway table lists all available batman-adv gateways in this network (see the [[batman-adv-gateways|gateway documentation]] to learn how to use this feature). Each line contains information about a specific gateway:
...
Batman-adv offers extended logging to understand & debug the routing protocol internals. After you activated debugging at compile time (instructions can be found in "the README file":http://open-mesh.org/projects/batman-adv/repository/revisions/master/entry/README ) and the appropriate log level has been set (read about the log levels [[tweaking-batman-adv|here]]) you can retrieve the logs by simply reading the 'log' file:
