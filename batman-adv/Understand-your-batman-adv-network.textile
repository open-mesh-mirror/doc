...
The gateway table lists all available batman-adv gateways in this network (see the [wiki:batman-adv-gateways gateway documentation] to learn how to use this feature). Each line contains information about a specific gateway:
...
'''Softinterface neighbor table'''

This table is part of the [wiki:bridge-loop-avoidance bridge loop avoidance] code and contains all nodes that have been detected as being part of the same bridge. The currently selected 'gateway to the LAN' is marked with the '=>' symbol.
