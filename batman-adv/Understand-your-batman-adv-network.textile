...
This table is part of the [[bridge-loop-avoidance|bridge loop avoidance]] code and contains all backbone gateways . Each line contains a backbone gateway which is reachable via LAN and mesh:
 ...
 * the originator address is not printed
 * If no VLAN was found a VID of '-1' is printed. 
 ...
 * fe:f0:00:00:01:01 on    -1    3.000s (3ba9)
</pre>
