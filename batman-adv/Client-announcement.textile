...
The TT_CRC is also usefull in case of node reboot: the TTVN will restart from 0 generating a strange situation (new_ttvn less than last_ttvn), but the TT_CRC will ensure that the receiving node will not accept this scenario and will request a "full table" to refresh its global one.
