...
- **MAC conflict**: in case of several node announcing the same client MAC address, the global table will be continuously updated leading to a route flip (towards the client) on all nodes
