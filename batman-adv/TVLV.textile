...
h2. Tlv types/featured to be tlv-ed:
...
So the packet gets as following:
<pre>
...
+           current  header                                                                               +
+---------------------------------------------------------------------------------------------------------+
+  type + Version +  length  + flags                                                                      +   /*Flags TLV*/
+---------------------------------------------------------------------------------------------------------+
+             seqno                                                                                       +
+---------------------------------------------------------------------------------------------------------+
+             orig                                                                                        +
...
+             prev_sender                                                                                 +
+---------------------------------------------------------------------------------------------------------+
+type +Version  +  length  +  gw_flags                                                                    +/*Gateway Flags TLV*/
+---------------------------------------------------------------------------------------------------------+
+              tq;                                                                                        +
+---------------------------------------------------------------------------------------------------------+
+  type  +  Version  +  length  +  tt_num_changes  +	   ttvn  +     tt_crc                             +/*TT TLV*/
+---------------------------------------------------------------------------------------------------------+
</pre>