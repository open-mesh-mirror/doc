...
h2.  Description of the API

A short API description can be found in the GSoC final report page: http://www.open-mesh.org/projects/batman-adv/wiki/GSoCfinalreportSpyros