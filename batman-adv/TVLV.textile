...
# -pay attention to the indentation (of parenthesis, parameters, whatever).
...
# -pay attention to what you did during your last rebase :) you accidentally removed the last fix introduced by Simon for batadv_bla_rx()
...
# -looking at this function tvlv_handler_unregister(), you should use kfree_rcu() instead of kfree()

# -you still have a lot of sizeof(uint8_t) in your code - please remove them

# -in main.c/tvlv_process(), you move the iterator outside of the loop.
stupid mistake, fixed

# -your tree does not seem to be rebased on master (again)?
rebased, sorry

# test the prototype with long lists of tvlvs and handler functions and also with weird tvlv values

# ask someone to increase the wiki logout timeout (please?)