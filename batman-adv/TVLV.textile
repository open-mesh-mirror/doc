 ...
 * TVLV_OGM_FOUND: tells the callback whether the tvlv has been found or not. This is needed to differentiate an invocation triggered by TVLV_OGM_CALL_IFNFOUND from the case of a "boolean tvlv" (no value)
