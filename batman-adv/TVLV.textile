...
> created a new branch (tvlvTemp) and pushed two patches, I'm not sure they are the right patches though and I'd like another git quick lesson on 3 way merge (what each file represents) and on git diff-ing if that's possible
