...
and a version byte
<pre>
 void callback(struct batadv_priv *bat_priv,
                       struct batadv_orig_node *orig,
                       uint8_t *value, uint8_t version);
</pre>

h3. Handlers

There is a specieal field for the handlers named call_always this enables the handler to be called with BATADV_NO_FLAGS as value and a 0 as version even if the appropriate tvlv wasnt received.
