...
TODO
   ...
   * Adding tvlv capabilities to the Gateway announcements and  flag transmissions-- Done
   * Appending tvlv info to the ogm packet -- Coded needs testing/debugging
   * Sending the packet -- Same as above
   * Receiving the pacekt -- To be coded
  Future Tasks:
