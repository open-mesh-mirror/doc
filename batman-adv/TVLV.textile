...
#)How can i split 
<pre>
struct batadv_tvlv_handler_node *tvlv_get_handler(struct batadv_priv *bat_priv, uint8_t type) ?
</pre>
#)Is there somewhere the description of the function names? (find_wrong_namespace.sh returns all of my functions)
#)i cloned the git://git.open-mesh.org/build_test.git but it didnt bring the sparse, cppcheck folders its 6 am  and i'm probably doing something wrong but please enlighten me
