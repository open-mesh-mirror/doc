...
* drivers for all radios are compiled in or instaled (ex. opkg install kmod-ath9k-htc)
...
set network.lan.ifname='wlan0 wlan0-1 eth0 bat0'
...
set wireless.radio1.beacon_int=58594
...
set wireless.radio2.beacon_int=58594
...
set wireless.@wifi-iface[0].ssid='$PUBLIC_ESSID'
...
set wireless.@wifi-iface[2].network=mesh0
set wireless.@wifi-iface[2].mode=adhoc 
set wireless.@wifi-iface[2].bssid=$MESH0_BSSID
set wireless.@wifi-iface[2].ssid='$MESH0_ESSID'
set wireless.@wifi-iface[2].mcast_rate=11000 

add wireless wifi-iface
set wireless.@wifi-iface[3].device=radio1 
set wireless.@wifi-iface[3].encryption=none
set wireless.@wifi-iface[3].network=mesh1
set wireless.@wifi-iface[3].mode=$MESH1_MODE
set wireless.@wifi-iface[3].bssid=$MESH1_BSSID
set wireless.@wifi-iface[3].ssid='$MESH1_ESSID'
set wireless.@wifi-iface[3].mcast_rate=11000 

add wireless wifi-iface
set wireless.@wifi-iface[4].device=radio2 
set wireless.@wifi-iface[4].encryption=none
set wireless.@wifi-iface[4].network=mesh2
set wireless.@wifi-iface[4].mode=$MESH2_MODE
set wireless.@wifi-iface[4].bssid=$MESH2_BSSID 
set wireless.@wifi-iface[4].ssid='$MESH2_ESSID'
set wireless.@wifi-iface[4].mcast_rate=11000 
commit" \
| uci batch
