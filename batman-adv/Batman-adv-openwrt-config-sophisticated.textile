...
but take in mind that wlan0-X interfaces will change names (wlan0-2 becomes wlan0-1), so you must also update two more lines:
<pre>
set network.lan.ifname='wlan0 eth0 bat0'
set network.mesh0.ifname=wlan0-1
</pre>
