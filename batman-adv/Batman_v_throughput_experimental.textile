...
No need to count sequence numbers anymore since it was related to packet loss, but time since last ECLP packet can be considered in order to quickly switch route.
