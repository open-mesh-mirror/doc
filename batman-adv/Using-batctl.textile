...
Batctl is the configuration and debugging tool for batman-adv. It is thoroughly documented in its man page, so please refer to "man batctl" on your system or "this online version":http://downloads.open-mesh.org/batman/manpages/batctl.8.html .

h2. Using batctl for configuration

All configuration of batman-adv is done in the virtual filesystem _sysfs_ and batctl is merely an convenient interface to this.
...
With debugfs mounted, you can use batctl to, among other, seeing the following:
