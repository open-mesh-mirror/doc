...
!{width: 50%25;}basic-multicast-switch.png!
...
However, this surpression mechanism leads another RFC to mandate an additional report surpression. Which in turn can potentially lead to a batman-adv node not receiving any MLD/IGMP report for a certain multicast address from a bridge port even though a listener behind that port exists:

!{width: 50%25;}basic-multicast-snooping-switch.png!
