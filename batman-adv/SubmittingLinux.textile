...
From git+ssh://open-mesh.org/srv/git/ecsv/linux-merge
...
'-(%25)-(linux)> git merge -s subtree origin/next
...
'-(%25)-(linux)> git rm net/batman-adv/Makefile.kbuild net/batman-adv/compat.h
...
'-(%25)-(linux)> vim net/batman-adv/Makefile
'-(%25)-(linux)> git add net/batman-adv/Makefile
'-(%25)-(linux)> git commit
[linux f2204f0] Merge remote branch 'origin/next' into linux
}}}
...
{{{
git diff origin/next: linux:net/batman-adv/
}}}
 ...
 * removed CHANGELOG, Makefile.kbuild, bat_printk.c and compat.h
...
{{{
'-(%25)-(linux)> git describe --tags --match "Greg*"
...
fatal: Not a valid object name master:net/batman-adv/TODO
