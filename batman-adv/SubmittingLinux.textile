...
'-(%25)-(maint)> git pull http://git.open-mesh.org/batman-adv/ maint
From http://git.open-mesh.org/batman-adv
...
'-(%25)-(166b2caa61fce5260aed4e119671764331fdc62a)> make CC=cgcc -C /home/sven/tmp/linux-next M=`pwd`
...
...
'-(%25)-(83d1bc8bb328bcfa42be492fe0e2648b77c18af2)> make CC=cgcc -C /home/sven/tmp/linux-next M=`pwd`
....
...
'-(%25)-(9e9605f0fe000f1097cb43271540ab2b76b2a782)> make CC=cgcc -C /home/sven/tmp/linux-next M=`pwd`
....
...
'-(%25)-(043aa9a54a5296c6027a5bcd808b8d29cea8a474)> make CC=cgcc -C /home/sven/tmp/linux-next M=`pwd`
...
...
'-(%25)-(f6d8baba5fce6161bc2cee9c97e0afbc139942c0)> make CC=cgcc -C /home/sven/tmp/linux-next M=`pwd`
...
...
'-(%25)-(a85d1b45e4cde0c882a41baaefeec0cd5502416f)> make CC=cgcc -C /home/sven/tmp/linux-next M=`pwd`
...
...
Usually I add "Staging: batman: " right when checking the signed-off-by and author (from) line.
...
{{{
'-(%25)-(greg)> git send-email --compose 00*.patch
}}}