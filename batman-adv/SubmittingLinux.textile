...
h2. get the linux-integration and linux-next repository
...
....
'-(%25)-> git clone git://git.kernel.org/pub/scm/linux/kernel/git/sfr/linux-next.git
Initialized empty Git repository in /home/batman/linux-next/.git/
remote: Counting objects: 1544059, done.
remote: Compressing objects: 100%25 (252781/252781), done.
....
'-(%25)-> cd linux-merge
...
We assume that the linux-next tree was already build with @make allnoconfig@ and then enabling @CONFIG_NET=y@, @CONFIG_MODULES=y@  and @CONFIG_CRC16=y@
...
'-(%25)-(166b2caa61fce5260aed4e119671764331fdc62a)> make CONFIG_BATMAN_ADV=m CC=cgcc -C ../linux-next M=`pwd`
...
...
'-(%25)-(83d1bc8bb328bcfa42be492fe0e2648b77c18af2)> make CONFIG_BATMAN_ADV=m CC=cgcc -C /home/batman/tmp/linux-next M=`pwd`
....
...
'-(%25)-(9e9605f0fe000f1097cb43271540ab2b76b2a782)> make CONFIG_BATMAN_ADV=m CC=cgcc -C ../linux-next M=`pwd`
....
...
'-(%25)-(043aa9a54a5296c6027a5bcd808b8d29cea8a474)> make CONFIG_BATMAN_ADV=m CC=cgcc -C ../linux-next M=`pwd`
...
...
'-(%25)-(f6d8baba5fce6161bc2cee9c97e0afbc139942c0)> make CONFIG_BATMAN_ADV=m CC=cgcc -C ../linux-next M=`pwd`
...
...
'-(%25)-(a85d1b45e4cde0c882a41baaefeec0cd5502416f)> make CONFIG_BATMAN_ADV=m CC=cgcc -C ../linux-next M=`pwd`
...
...
'-(%25)-(batman-adv/next)> git request-pull 12513b76a021e5b41a9d5d5981da75dfd6480890 git://git.open-mesh.org/linux-merge.git > shortlog
