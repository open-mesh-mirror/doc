 ...
 * removed CHANGELOG, Makefile.kbuild, bat_printk.c, README, sysfs-class-net-batman-adv, sysfs-class-net-mesh and compat.h
...
All done.
'-(%25)-(patches)> git diff origin/merge/master
}}}
...
Applying: batman-adv: adapting source version to revised versioning scheme
Applying: batman-adv: Add include guards to all header files
'-(%25)-(batman-adv/next)> git request-pull 12513b76a021e5b41a9d5d5981da75dfd6480890 git://git.open-mesh.org/ecsv/linux-merge.git > shortlog
