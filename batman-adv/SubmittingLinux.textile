...
BASE_NETNEXT=1fe323aa1b2390a0c57fb0b06a782f128d49094c
BASE_NET=1fe323aa1b2390a0c57fb0b06a782f128d49094c
</pre>
...
GIT_SEQUENCE_EDITOR="sh -c 'git rev-list --reverse --no-merges '\\''${LM_NEXT}..origin/next'\\'' --not origin/maint|awk '\\''{ print \"pick \"\$1}'\\'' > \$1' \$@" \
 git rebase -i origin/maint --onto "${LM_NEXT}" --no-ff
</pre>
