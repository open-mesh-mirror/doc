...
# *Merge fragments*
  The first fragment in the list (which is the last received fragment, see item no. 2) is expanded to contain the payload of the rest of the fragments, which are then copied into the first fragment.
