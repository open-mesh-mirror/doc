...
*Before:*
If the size of the local table exceeds the MTU, batman-adv simply truncates the response. This response leads to a wrong CRC at the receiver of the response, who then issues a new request. This loop will repeat until the local table fits the MTU again.
