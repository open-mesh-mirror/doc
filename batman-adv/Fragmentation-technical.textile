...
** Fragments should be stored in order to ease the merging.
** Read-Black Trees could also be used. 
* Do we want the new fragmentation features to be optional at compiletime?
...
struct frag_packet {
	...
	uint16_t frag_seqno; /* Almost unique id for the set of fragments (CRC?) */
	uint8_t frag_no:4; /* Number of fragments in this set */
	uint8_t flags:4; /* Sequence number of this fragment */
} __packed;
</pre>
