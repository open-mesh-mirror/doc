...
it has already been "implemented and tested on top of batman-adv 2013.0.0":https://git.open-mesh.org/batman-adv.git/log/?h=linus/multicast-rebase
...
* there is a working, "feature complete", but not much tested "patchset based on v2013.0.0":https://git.open-mesh.org/batman-adv.git/log/?h=linus/multicast-rebase which should work for any IP multicast data (no more code changes other than bug, comment or commit message fixes intended)
