 ...
 * there is a working, "feature complete", but not much tested "patchset based on v2013.0.0":http://git.open-mesh.org/batman-adv.git/shortlog/refs/heads/linus/multicast-rebase which should work for any IP multicast data (no more code changes other than bug, comment or commit message fixes intended)
