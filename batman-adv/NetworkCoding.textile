...
To enable network coding, enable it a compile time (consult "the README.external file":https://git.open-mesh.org/batman-adv.git/blob/refs/heads/master:/README.external to learn how to set the compile option). It can be disabled at runtime with batctl or in sysfs:
<pre>
# batctl nc 0
