...
To enable network coding, enable it a compile time (consult "the README.external file":https://git.open-mesh.org/batman-adv.git/blob/refs/heads/main:/README.external to learn how to set the compile option). It can be turned off at runtime with batctl:
<pre>
# batctl nc 0
</pre>
