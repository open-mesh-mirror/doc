h1. Proposal: Unicasting Unsolicited Neighbor Advertisements
...
!{width: 80%25;}unsol-NA-flooded.png!
...
!{width: 80%25;}unsol-NA-lost-data.png!
...
!{width: 80%25;}unsol-NA-unicast.png!

_A unicasted unsol. NA updating the MAC table of the switch_

For all the other batman-adv nodes potentially having a switches, nothing has changed for these switches even after the roaming: For them, host A is still somewhere in the mesh and therefore still behind the same switch port leading to the mesh.
