...
!{width: 66%;}basic-multicast-single-receiver.png!

If a single multicast listener was detected then the packet is forwarded directly to the corresponding batman-adv node.
...
* If the IPv4 multicast destination is between 224.0.0.1 and 224.0.0.255.
* If the IPv6 multicast destination is ff02::1.

h2. How to activate the multicast optimizations?
