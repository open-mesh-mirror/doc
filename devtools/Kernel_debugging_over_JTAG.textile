...
!/attachments/download/945/jtag-rpi4.svg!
...
h2. Preparing the 8devices lima target board
...
!/attachments/download/946/jtag-8devices-lima.svg!
...
+		EXTRA_CFLAGS="$(PKG_EXTRA_CFLAGS) -fno-inline -Og -fno-reorder-blocks -fno-ipa-cp-clone -fno-partial-inlining" \
