...
OpenWrt must be modified slightly (attachment:0003-openwrt-Add-support-for-easily-selectable-kernel-deb.patch) to expose the kernel gdbstub (@CONFIG_KERNEL_KGDB@):
...
Also alternative TTY multiplexers like "tty2pty-mux":https://github.com/ecsv/tty2pty-mux can be used to achieve the same.
